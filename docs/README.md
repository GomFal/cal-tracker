...
| `abuse-and-cost-controls.md` | Active auth, email, LLM/STT rate-limit semantics, emergency controls, proxy trust, and MVP deployment limits. | Subscription plans or general observability architecture. |
