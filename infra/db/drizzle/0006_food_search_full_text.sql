ALTER TABLE food_search_documents
...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS food_search_documents_search_vector_idx
  ON food_search_documents USING gin (search_vector);
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS food_search_documents_generic_trgm_idx
